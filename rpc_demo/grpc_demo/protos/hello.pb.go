...
func init() {
	proto.RegisterType((*String)(nil), "protos.String")
}
...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0xc9, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x03, 0x53, 0xc5, 0x4a, 0x72, 0x5c, 0x6c,
	0xc1, 0x25, 0x45, 0x99, 0x79, 0xe9, 0x42, 0x22, 0x5c, 0xac, 0x65, 0x89, 0x39, 0xa5, 0xa9, 0x12,
	0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x10, 0x8e, 0x51, 0x1a, 0x17, 0x8f, 0x07, 0x48, 0x5b, 0x70,
	0x6a, 0x51, 0x59, 0x66, 0x72, 0xaa, 0x90, 0x3a, 0x17, 0x2b, 0x98, 0x2f, 0xc4, 0x07, 0x31, 0xa8,
	0x58, 0x0f, 0xa2, 0x5d, 0x0a, 0x8d, 0x2f, 0xa4, 0xcb, 0xc5, 0xee, 0x9c, 0x91, 0x98, 0x97, 0x97,
	0x9a, 0x43, 0x48, 0xa9, 0x06, 0xa3, 0x01, 0x63, 0x12, 0xc4, 0x3d, 0xc6, 0x80, 0x00, 0x00, 0x00,
	0xff, 0xff, 0xf2, 0xb6, 0xef, 0xe3, 0xa5, 0x00, 0x00, 0x00,
}
...
func (c *helloServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[0], "/protos.HelloService/Channel", opts...)
	if err != nil {
		return nil, err
	}
